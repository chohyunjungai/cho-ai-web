...
작성: 2026-07-05 · 상태: **확정 (2026-07-05 소유자 승인, video_tags 221행 시딩 완료)**
확정 내용: AI 도구·활용(ai-tools)·**업무자동화(automation)**·학교·교사(school) 추가, 성적·평가·학급·학사 제거 → task 10개. 아래 표의 `learn-automation`은 확정 명칭 `automation(업무자동화)`으로, `school` 표기는 그대로 시딩됨.
