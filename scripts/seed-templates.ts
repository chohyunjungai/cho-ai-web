...
const DATA: T[] = [
  ...
  { slug: 'automation-school-10-extra', title: 'AI자동화학교 10강 보조 시트', type: 'sheet', fileId: '1qpxwZ5ZOuWClFsP29RPiaenqfg1eSaL2fcJbAfCvF1k', videos: [63], auth: true, status: 'draft', note: '제목 조회 실패 — 공유 설정 확인 필요' },
  ...
  { slug: 'comment-collector-code', title: '유튜브 댓글 수집 코드', type: 'doc', fileId: '1ES_1theSAVYPw8BSZw1uKgvR4WJLCILlvXQ-QEd7mfY', videos: [17], auth: false, status: 'draft', note: '제목 조회 실패 — 공유 설정 확인 필요' },
